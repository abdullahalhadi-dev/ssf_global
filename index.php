...
<html lang="en">
  <head>
    ...
    <title>SSF Global - A Global Leading Web Agency</title>
  ...
  <!-- START: section -->
  <section class="probootstrap-intro" style="background-image: url(img/hero_bg.jpg);" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-7 probootstrap-intro-text">
          <h1 class="probootstrap-animate" data-animate-effect="fadeIn"><span>SSF</span>Global</h1>
          <div class="probootstrap-subtitle probootstrap-animate" data-animate-effect="fadeIn">
            <h2>A Leading Web Agency</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="next-section" class="probootstrap-section">
      <div class="container">
        <div class="row probootstrap-gutter60 mb50">
          ...
          <div class="col-md-6">
            <h2 class="probootstrap-heading">About Us</h2>
            ...
            <p><a href="#" class="btn btn-primary">Read more about us</a></p>
          </div>
        </div>
