...
<html lang="en">
  <head>
    ...
    <title>SSF Global - About Us</title>
  ...
  <!-- START: section -->
  <section class="probootstrap-intro probootstrap-intro-inner" style="background-image: url(img/hero_bg.jpg);" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-7 probootstrap-intro-text">
          <h1 class="probootstrap-animate" data-animate-effect="fadeIn">About</h1>
    ...
    <section id="next-section" class="probootstrap-section">
      <div class="container">
        <div class="row probootstrap-gutter60 mb50">
          <div class="col-md-6">
            <figure><img src="img/about_us.jpg" lt="Free Bootstrap Template by uicookies.com" class="img-responsive"></figure>
          </div>
          <div class="col-md-6">
            <h2 class="probootstrap-heading">Hello, We are SSF Global!</h2>
            <p>SSF Global stands as a pioneering force in the realm of web agency services, poised to redefine digital excellence on a global scale. With a relentless commitment to innovation, we craft compelling online experiences that transcend boundaries and resonate with audiences worldwide.</p>

            <p>Our foundation rests upon a fusion of creative ingenuity and technical expertise. As a team of dedicated visionaries, we specialize in developing bespoke websites that mirror our clients' aspirations and drive transformative growth.</p>
          </div>
        </div>

        <div class="row probootstrap-gutter60">
          <div class="col-md-4 mb30">
            <h4 class="mb30">Our Mission</h4>
            <p>&ldquo;Elevate brands globally with visionary websites. Fusing creativity and tech to drive growth and exceed expectations.&rdquo;</p>
          </div>
          <div class="col-md-4 mb30">
            <h4 class="mb30">Upcoming Services</h4>
              ...
              <li>
                <a href="#">
                  ...
                  <div class="probootstrap-text">
                    ...
                    <span class="meta">September, 14 2023</span>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  ...
                  <div class="probootstrap-text">
                    ...
                    <span class="meta">November, 01 2023</span>
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  ...
                  <div class="probootstrap-text">
                    ...
                    <span class="meta">December, 23 2023</span>
                  </div>
                </a>
              </li>
            </ul>
          ...
          <div class="col-md-4 mb30">
            <h4 class="mb30">Our Vision</h4>
            <p>&ldquo;SSF Global envisions a digital landscape where creativity knows no bounds. We aspire to be the catalyst for transformative online experiences, revolutionizing brand impact and pushing the boundaries of innovation.&rdquo;</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 probootstrap-relative">
            <h2 class="probootstrap-heading mt0 mb50">Our Team</h2>
            ...
            <div class="owl-carousel owl-carousel-carousel">
              <div class="item">
                <div class="probootstrap-program">
                  ...
                  <h3>Md. Shimul Hossain</h3>
                  <p>Team Lead, KAM & CRM</p>
                </div>
              </div>
              <div class="item">
                <div class="probootstrap-program">
