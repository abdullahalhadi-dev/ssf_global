...
<html lang="en">
  <head>
    ...
    <title>SSF Global - Contact Us</title>
    ...
    <section id="next-section" class="probootstrap-section">
      <div class="container">
        <div class="col-md-6">
            ...
            <form action="contact_form_data.php" method="post" class="probootstrap-form">
              <div class="row">
                <div class="col-md-6">
          ...
          <div class="col-md-5 col-md-push-1">
            ...
            <h3>Feedback</h3>
            <p>Your valuable feedback serves as the cornerstone of our evolution. We deeply appreciate your insights, which guide us in refining our services and ensuring an exceptional journey of collaboration and growth. Your thoughts empower us to consistently enhance our offerings, shaping a better experience for all.</p>
          </div>
